...
export const ACHIEVEMENTS = [
  { id: 'first',     emoji: '🎯', title: t('Première séance','First workout'),   desc: t('Tu t’es lancé. Le plus dur est fait.','You started. The hardest part is done.'),
    f: c => ({ cur: c.n, target: 1 }) },
  { id: 'w5',        emoji: '🔥', title: t('Régulier','Regular'),                desc: t('5 séances au compteur.','5 workouts logged.'),
    f: c => ({ cur: c.n, target: 5 }) },
  { id: 'w25',       emoji: '💪', title: t('Assidu','Dedicated'),               desc: t('25 séances — ça devient une habitude.','25 workouts — it’s a habit now.'),
    f: c => ({ cur: c.n, target: 25 }) },
  { id: 'w100',      emoji: '🏆', title: t('Centurion','Centurion'),            desc: t('100 séances. Respect.','100 workouts. Respect.'),
    f: c => ({ cur: c.n, target: 100 }) },
  { id: 'pr1',       emoji: '🥇', title: t('Premier record','First PR'),        desc: t('Ton premier record personnel.','Your first personal record.'),
    f: c => ({ cur: c.prs, target: 1 }) },
  { id: 'pr10',      emoji: '📈', title: t('Machine à records','PR machine'),   desc: t('10 records battus.','10 PRs smashed.'),
    f: c => ({ cur: c.prs, target: 10 }) },
  { id: 'streak3',   emoji: '⚡', title: t('En feu','On fire'),                 desc: t('3 semaines d’affilée à ton objectif.','3 weeks in a row hitting your goal.'),
    f: c => ({ cur: c.streak, target: 3 }) },
  { id: 'streak8',   emoji: '🌟', title: t('Inarrêtable','Unstoppable'),        desc: t('8 semaines d’affilée. Machine.','8 weeks in a row. Machine.'),
    f: c => ({ cur: c.streak, target: 8 }) },
  { id: 'vol10',     emoji: '🏋️', title: t('10 tonnes','10 tonnes'),           desc: t('10 000 kg soulevés en tout.','10,000 kg lifted in total.'),
    f: c => ({ cur: c.volume, target: 10000 }) },
  { id: 'vol100',    emoji: '🦾', title: t('100 tonnes','100 tonnes'),          desc: t('100 000 kg. Une vie de fonte.','100,000 kg. A lifetime of iron.'),
    f: c => ({ cur: c.volume, target: 100000 }) },
  { id: 'variety20', emoji: '🎨', title: t('Polyvalent','Versatile'),           desc: t('20 exercices différents essayés.','20 different exercises tried.'),
    f: c => ({ cur: c.exos, target: 20 }) },
  { id: 'allgroups', emoji: '🧩', title: t('Corps complet','Full body'),        desc: t('Tous les groupes musculaires travaillés.','Every muscle group trained.'),
    f: c => ({ cur: c.groups, target: 6 }) },
  { id: 'bigweek',   emoji: '📅', title: t('Grosse semaine','Big week'),        desc: t('5 séances en une seule semaine.','5 workouts in a single week.'),
    f: c => ({ cur: c.bestWeek, target: 5 }) },
  { id: 'earlybird', emoji: '🌅', title: t('Lève-tôt','Early bird'),            desc: t('Une séance avant 8 h du matin.','A workout before 8 AM.'),

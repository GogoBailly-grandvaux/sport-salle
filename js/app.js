  ...
  return new Promise(resolve => {
    ...
    view.innerHTML = `<div class="welcome">
      ...
      <div class="wel-body">
        ...
        <p class="wel-punch">${t('Tout ce que les autres font payer.','Everything others charge for.')} <b>${t('Gratuit.','Free.')}</b></p>
        <div class="wel-freebies">${[
          t('Stats avancées','Advanced stats'), t('Exercices personnalisés','Custom exercises'),
          t('Échauffements auto','Auto warm-ups'), t('Récupération musculaire','Muscle recovery'),
          t('Historique illimité','Unlimited history'), t('Zéro pub','Zero ads'),
        ].map(x => `<span>${icon('check')} ${x}</span>`).join('')}</div>
        <div class="wel-feats">
